...
// Handle Search by Feedback ID
if (isset($_POST['searchFeedback']) && $searchTerm) {
    $sql = "SELECT * FROM feedback WHERE feedbackID LIKE ?";
...
if (isset($_POST['deleteFeedback'])) {
    ...
    $stmt->close();
    $result = $conn->query("SELECT * FROM feedback"); // Refresh the results after deletion
}
?>
...
<div class="circle circle2"></div>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="post">
                <input type="text" name="searchTerm" placeholder="Search by Feedback ID" value="<?php echo $searchTerm; ?>">
                <button type="submit" name="searchFeedback">Search</button>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" style="display:inline;">
                                    ...
                                    <button type="submit" name="deleteFeedback" onclick="return confirm('Are you sure you want to delete this feedback?');">Delete</button>
                                </form>
                            </td>
                        </tr>
                    <?php endwhile; ?>
